...
export PLDM_FWUP_IMG_GEN = ${SCRIPTS_DIR}/pldm_scripts/pldm_fwup_scripts/pldm_fwup_pkg_creator.py
export PLDM_FWUP_IMG_INFO_GEN = ${SCRIPTS_DIR}/pldm_scripts/pldm_fwup_scripts/pldm_fwup_img_info_creator.py
export PLDM_REDFISH_DICT_GEN = ${SCRIPTS_DIR}/pldm_scripts/pldm_redfish_scripts/pldm_redfish_dict_gen.py
