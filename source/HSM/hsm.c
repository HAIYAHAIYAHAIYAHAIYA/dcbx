...
S_state_fun father_state[2] = {
    ...
    {F_Run_Init, F_Run_Keep, F_Run_Done, F_Run_Default}}; //--超类/父类
S_state_fun childer_state[8] = {
    ...
    {C_Run_Avoid_Obstacles_Init, C_Run_Avoid_Obstacles_Keep, C_Run_Avoid_Obstacles_Done, C_Run_Avoid_Obstacles_Default}}; //--子类1
